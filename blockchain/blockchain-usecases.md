# Blockchain based Intergation Usecases 
...
## Implement company promises as smart contracts 	
...
# To Avoid Coercion 
## Avoid coercion as Certification Authority  
...
## Auditing: Track who did what inside the company.
...
##Support health data kept in with a patient (U7) 
...
## Give users control of their health data 
...
#Couple a “thing” (e.g. product) with a blockchain
...
## Use case: Revoke API tokens.
* **Implementation:** This is similar to verifiable token implementation discussed in IAM architecture pattern.  
* **Other use cases:** This can be applied to all API and OAuth use cases, e.g. revoke the driving license or dismiss an employee.
